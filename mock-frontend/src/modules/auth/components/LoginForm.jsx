...
export function LoginForm({ form, onChange, onSubmit, submitting, submitLabel }) {
  const handleGoogleRedirect = (e) => {
    e.preventDefault()
    window.location.href = 'https://prqowmqmkeqhpkkxqfdz.supabase.co/auth/v1/authorize?provider=google&redirect_to=http://localhost:5173/auth'
  }
  ...
  return (
    <form className="auth-form" onSubmit={onSubmit}>
      ...
      <button className="secondary google-action" type="button" onClick={handleGoogleRedirect} disabled={submitting}>
