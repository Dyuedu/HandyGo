...
import { JobPostManagement, JobPostDetail, JobPostApplicants, JobPostDiscovery, JobPostDiscoveryMap } from '../modules/jobpost'
    ...
    <Routes>
      ...
      <Route element={<PrivateRoute />}>
        <Route element={<MainLayout />}>
          ...
          <Route path="/app/job-posts/:jobPostId/applicants" element={<JobPostApplicants />} />
